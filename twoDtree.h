...
public:
   ...
   * You may want a recursive helper function for this one.
   ...
   //helper
    double countleaves(Node* node);
    void prune2(Node* node,double pct,int tol);
    bool pruneHelper(Node* node,double pct,int tol);
    double helper(Node* node, RGBAPixel pixel, int tol);
    void getleaves(Node* n);
...
private:
   ...
   */
   void copy(const twoDtree & other);
    ...
    //helper
    void copyHelper(Node* r,Node* treeNewRoot);
